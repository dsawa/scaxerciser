        ...
        for (y=0;y<btnGroups.length;y++) {
          ...
          for (z=0;z<buttons.length;z++) {
            var button = buttons[z],
                ...
                buttonTitle = this.$options.language[button.titleIdx] ? this.$options.language[button.titleIdx] : button.title;

            if (button.toggle == true) {
              buttonToggle = ' data-toggle="button"'
            }

            if (this.$options.language[button.btnTextIdx]) {
              btnText = this.$options.language[button.btnTextIdx];
            }
    ...
    buttons: [
      [{
        ...
        data: [{
          name: 'cmdPreview',
          toggle: true,
          titleIdx: 'titlePreview',
          title: 'Preview',
          btnTextIdx: 'btnTextPreview',
          btnText: 'Preview',

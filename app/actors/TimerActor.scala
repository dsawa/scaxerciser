...
class TimerActor extends Actor {
  ...
  def removeUserTimer(userId: String) = usersTimes -= userId
...
case class Start(userId: String) extends SocketMessage

case class Stop(userId: String) extends SocketMessage
